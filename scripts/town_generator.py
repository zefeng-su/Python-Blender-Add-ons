...
forest_size = 20 # number of mesh generated
forest_scale = 60 # distribution, smaller value = more dense population
...
#-------------------------------------------
#beta distribution
town_alpha = 1  # α parameter, note:(should be > 0)
town_beta = 1 # β parameter, note:(should be > 0)
town_size = 10 # number of mesh generated
town_scale = 60 # distribution, smaller value = more dense population
rng = np.random.default_rng()
